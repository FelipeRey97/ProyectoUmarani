    ...
    <div class="contacto">
        ...
        ?>
            ...
            <form action="" method="post" class="iniciar-sesion" enctype="multipart/form-data">
                ...
                <input required pattern="[a-zA-Z ]{3,100}" class="control" type="text" required name="pNombre">  <br>
                <label for="">Email * :</label><br>
                <input required class="control" type="text" required name="pMail" >  <br>
                <label  for="">Télefono de contacto :</label><br>
                <input pattern="[0-9]{6,12}" class="control" type="text" required name="ptelefono">  <br>
                <label required for="">Escribe tu mensaje * :</label><br><br>
                <textarea rows="7" cols="52" class="" name="pComentario"></textarea><br><br>

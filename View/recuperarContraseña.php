...
require_once('../Controller/recuperarContraseña.php');
?>
...
<?php if (isset($_SESSION['Rmail'])){ ?>
    <div class="form-container">
                <h1>Asignar nueva Clave</h1><br>
                <p class="recuperacion">Introduce la nueva contraseña</p>
            <form action="" method="post" class="iniciar-sesion">
                <label for="">Nueva Clave:</label><br>
                <input class="control" type="password" name="Rclave1" required>  <br>
                <label for="">Confirmar Nueva Clave:</label><br>
                <input class="control" type="password" name="Rclave2" required>  <br>
                <input class="enviar" name="recuperar" type="submit" value="recuperar">
            </form>
        </div>
         ...
         <?php }else{  ?>
            ...
            <p class="recuperacion">Introduce el correo con que registraste tu cuenta</p>
            <form action="" method="post" class="iniciar-sesion">
            <label for="">Correo electrónico:</label><br>
            <input class="control" type="e-mail" name="Rmail" required>  <br>

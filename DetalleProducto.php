...
<body>
    ...
    <link rel="stylesheet" href="../WebUmarani/CSS/detalleProdEstilos.css">
    ...
    <div class="padre">
        <header class="header">
            <div class="contacto">
                ...
                <div class="logo">
                    <a href="#"><img src="../WebUmarani/imagenes/logo.jpeg" alt=""></a>
                </div>
                <div class="buscador">
                    <form action=""><input class="buscar" type="text" placeholder="Ingresa tu búsqueda">
                        <input class="boton" type="submit" value="Buscar"></form>
                </div>
                <div class="redsocial">
            ...
            <div class="menu">
                <b><a href="../WebUmarani/Index.html">Inicio</a></b>
        ...
        <section class="section">
            <div class="producto">
                <div class="imagen">
                    <img src="../WebUmarani/imagenes/Anillos/anillo1.jpg" alt="">
                </div>
            </div>
            <div class="detalles">
                <div class="titulo">
                    <h1>Violet Collar</h1> <br><br>
            ...
            <div class="valor">
                <div class="precio"><p href="#"><b>$ 15.000</b></p><br></div>
                   <div class="estado"><p href="#"><b>Disponible</b></p><br></div> 
                    <div class="comprar"><a href=""><i class="fas fa-cart-plus"></i> Añadir al carrito</a><br></div>
                    <div class="favoritos"><a href=""><i class="fas fa-heart"></i><b> Añadir a Favoritos</b></a><br></div>
            </div>
